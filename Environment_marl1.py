...
class Environ:
    def __init__(self, n_veh, n_neighbor):
        ...
        self.demand_size = int((4 * 190 + 300) * 8 * 5)  # V2V payload: 2 * 1060 Bytes every 100 ms
    ...
    def Compute_Performance_Reward_Test_rand(self, actions_power):
        ...
        for i in range(self.n_RB):  # scanning all bands
            ...
            for j in range(len(indexes)):
                ...
                #  V2V interference
                for k in range(j + 1, len(indexes)):  # spectrum-sharing V2Vs  频谱共享的V2Vs
                    receiver_k = self.vehicles[indexes[k][0]].destinations[indexes[k][1]]
    ...
    def Compute_Interference(self, actions):
        ...
        # interference from V2I links  V2I的链路的干扰
